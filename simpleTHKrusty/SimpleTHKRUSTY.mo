...
import Modelica.Constants.pi;
  ...
  final constant Integer N = 20 "Number of radial shells"; //tested up to 50
  ...
  parameter Real fuel_volume = 0.00186454; //computed in OpenFOAM from mesh. 
...
// --- Heat Pipe / Boundary Parameters ---
  parameter Real T_HP_steady = 1026.5429645486927; //1073.5; //873.15 "Fixed HP temperature for steady-state [K]";
